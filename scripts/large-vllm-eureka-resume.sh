...
#SBATCH -J large-vllm-eureka-resume
#SBATCH -o slurm_logs/large-vllm-eureka-resume/%j.out
...
CUDA_VISIBLE_DEVICES=0 python eureka.py model=$MODEL env=$2 resume=True stats_file=$3
