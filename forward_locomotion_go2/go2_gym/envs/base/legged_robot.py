...
from forward_locomotion_go2.go2_gym.envs.base.base_task import BaseTask
...
class LeggedRobot(BaseTask):
    ...
    def _get_env_origins(self, env_ids, cfg):
        ...
        if cfg.terrain.mesh_type in ["heightfield", "trimesh"]:
            ...
            xx, yy = torch.meshgrid(torch.arange(num_rows).to(self.device), torch.arange(num_cols).to(self.device))
