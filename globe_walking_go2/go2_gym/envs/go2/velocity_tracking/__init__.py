...
from globe_walking_go2.go2_gym.envs.base.legged_robot import LeggedRobot
...
class VelocityTrackingEasyEnv(LeggedRobot):
    def __init__(self, sim_device, headless, num_envs=None, prone=False, deploy=False,
        ...
        super().__init__(cfg, sim_params, physics_engine, sim_device, headless, eval_cfg, initial_dynamics_dict, reward_struct=reward_struct)
