...
from globe_walking_go2.go2_gym.envs.base.base_task import BaseTask
...
class LeggedRobot(BaseTask):
    ...
    def initialize_sensors(self):
        """ Initializes sensors
        """
        from globe_walking_go2.go2_gym.sensors import ALL_SENSORS
    ...
    def create_sim(self):
        ...
        from globe_walking_go2.go2_gym.terrains import ALL_TERRAINS
    ...
    def _create_envs(self):
        ...
        # create robot
        from globe_walking_go2.go2_gym.robots.go2 import Go2
        ...
        # create objects
        from globe_walking_go2.go2_gym.assets.ball import Ball
        ...
        if self.cfg.perception.measure_heights:
            from globe_walking_go2.go2_gym.sensors.heightmap_sensor import HeightmapSensor
            self.heightmap_sensor = HeightmapSensor(self)

        # if recording video, set up camera
        if self.cfg.env.record_video:
            from globe_walking_go2.go2_gym.sensors.floating_camera_sensor import FloatingCameraSensor
        ...
        from globe_walking_go2.go2_gym.utils.logger import Logger
    ...
    def initialize_cameras(self, env_ids):
        ...
        from globe_walking_go2.go2_gym.sensors.attached_camera_sensor import AttachedCameraSensor
